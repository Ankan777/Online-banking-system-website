...
<head>
    ...
    <title>Check Balance - Ankan's Netbank</title>
        ...
        <div class="container" style="margin-top: 10%; padding:10px 80px 10px 80px; ">
            ...
            <div class="container"
                ...
                <form action="balance.php" method="post">
                    ...
                    <p style="color:white;">Don't remember your account number?<a href="allcust.php">Check here</a>
                    </p>
                </form>
            </div>
        </div>
...
if($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    $sql = "SELECT Balance FROM atm where AccountNo='$accno'";
