...
<head>
    ...
    <title>Welcome to Ankan's Netbank</title>
...
<div id="container">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br> Ankan's Netbank
                    </b></p>
            </div>
    ...
    <center style="margin:60px 0px 20px 0px;">
        <div class="container"
            ...
            <h1 style="text-shadow:2px 2px 2px gray; color:white;"><b>Here are our Awesome Facilities</b></h1>
                ...
                <div class="row">
                    <div class="col-lg">
                        <div
                            ...
                            <h6>Watch every customer who avail our services.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                    ...
                    <div class="col-lg">
                        <div
                            ...
                            <a href="balance.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
