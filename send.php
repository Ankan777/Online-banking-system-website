...
<head>
    ...
    <title>Send money - Ankan's Netbank</title>
            ...
            <b>
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item" style="margin-left:15px; ">
                        <a class="nav-link text-nowrap active" href="send.php">Send Money</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="allcust.php">View All Customers</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
                        <a class="nav-link text-nowrap" href="alltransact.php">Transactions</a>
                    </li>
                    <li class="nav-item" style="margin-left:15px;">
    ...
    <center>
        ...
        <div class="container" style="margin-top:2%;">
            <div
                ...
                <h1 style=" color:white;">Transfer your Money</h1>
            </div>
            <br><br>
            <div class="" style=" backdrop-filter: blur(5px);  border-radius:5px;  ">
                <form action="send.php" method="post">
                    ...
                    <p style="color:white;">Want to check your balance? check <a href="balance.php">here</a></p>
                </form>
            </div>
        </div>
...
if($_SERVER['REQUEST_METHOD']== 'POST'){
    ...
    $checkblcquery = "SELECT Balance FROM atm where AccountNo='$sender'";
    $checkblc = mysqli_query($conn, $checkblcquery);
    $ava_blc = mysqli_fetch_assoc($checkblc)['Balance'];

    if($ava_blc >= $amount){
    $sql1 = "UPDATE atm SET Balance=  Balance-$amount WHERE AccountNo ='$sender'";
    $sql2 = "UPDATE atm SET  Balance=  Balance+$amount WHERE  AccountNo ='$reciever'";
